...
public class DisassemblerView extends ViewPart {
    ...
    private final ContextNode gameBoyNode=new ContextNode() {
    	public void detach() { DisassemblerView.this.detach(); }
    };
    ...
    // Disassembler screen.
	//--------------------------------------------------------------------------------    
    private final int screenPalette[]=new int[256];
    
    final DisassemblerScreen disassemblerScreen=new DisassemblerScreen() {
