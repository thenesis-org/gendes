...
public interface IReadmeConstants {
    ...
    public static final String ACTION_SET_RETARGET4 = "org_thenesis_emulation_eclipse_readmeRetargetAction"; //$NON-NLS-1$

    public static final String ACTION_SET_LABELRETARGET5 = "org_thenesis_emulation_eclipse_readmeRelabelRetargetAction"; //$NON-NLS-1$
